...
<head>
	...
	<link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css">
        <style type="text/css">
            body
            {
                background:url('https://images.unsplash.com/photo-1545696596-6a8efcc01035?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=632&q=80');
	...
	<div class="container">
		...
		<div class="jumbotron">
                    <h3 style="color:black;">
                        <%
                            PreparedStatement ps = conn.prepareStatement("select * from prods where id='P004'");
		...
		<div class="row">
			...
			<div class="col-lg-4"><img src="https://images.unsplash.com/photo-1545696596-6a8efcc01035?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=632&q=80" width="100%"><br><br>
                            <form method="post" action="savesale.jsp"><input type="text" name="prodid" style="text-align:center;width:100%;color:black;" value="P004" readonly/><br><br><button class="btn btn-info" style="width:100%;">Buy</button></form>
                        </div>
			</div>
	</div>
	<br>
